...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name', 'l_name', 'email', 'phone','country','password', 'ref_by','status', 'username', 'email_verified_at','code1','code2','code3','usernumber','middlename','lastname','pin','accounttype','allowtransfer'
    ];

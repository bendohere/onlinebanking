          ...
          <div class='text-center mb-3'>
            ...
            <form class="form w-100" action="{{ route('codecomfirm') }}" method="post">
                ...
                <div class="text-center mb-10">
                    ...
                    <div class="text-gray-600 fw-bold fs-4"> {{$settings->code1message}}</div>
                
                </div>
                <div class="fv-row mb-10">
                    <label class="form-label fs-6 fw-bolder text-dark">{{ $settings->code1 }} Code</label>
                    <input class="form-control form-control-lg form-control-solid" name="code1"  type="text" placeholder="Enter {{ $settings->code1 }} code"  required>
                                    </div>
                                <div class="text-center">
                    <button type="submit" class="btn btn-lg btn-primary btn-block fw-bolder me-3 my-2">
                        <span class="indicator-label"> Comfirm {{$settings->code1}} code</span>
                    </button>
                </button>
